...
func (*Local) UploadFile(file *multipart.FileHeader) (string, string, error) {
	...
	if mkdirErr != nil {
		global.GvaLog.Error("function os.MkdirAll() failed", zap.Any("err", mkdirErr.Error()))
	...
	if copyErr != nil {
		global.GvaLog.Error("function io.Copy() failed", zap.Any("err", copyErr.Error()))
...
func (*Local) DeleteFile(key string) error {
	...
	p := filepath.Join(global.GvaConfig.Local.StorePath, key)
